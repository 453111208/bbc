...
!g["*"]&&f("*")}function Ha(a,b){var c,e,f=d.ajaxSettings.flatOptions||{};for(c in b)void 0!==b[c]&&((f[c]?a:e||(e={}))[c]=b[c]);e&&d.extend(!0,a,e);return a}function Ia(a,b,c,e){var f;if(d.isArray(b))d.each(b,function(b,d){c||Sb.test(a)?e(a,d):Ia(a+"["+("object"===typeof d?b:"")+"]",d,c,e)});else if(c||"object"!==d.type(b))e(a,b);else for(f in b)Ia(a+"["+f+"]",b[f],c,e)}function mb(a){return d.isWindow(a)?a:9===a.nodeType&&a.defaultView}var $=[],N=$.slice,nb=$.concat,Ja=$.push,la=$.indexOf,ra={},
Tb=ra.toString,Ka=ra.hasOwnProperty,x={},t=v.document,d=function(a,b){return new d.fn.init(a,b)},Ub=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Vb=/^-ms-/,Wb=/-([\da-z])/gi,Xb=function(a,b){return b.toUpperCase()};d.fn=d.prototype={jquery:"2.1.4",constructor:d,selector:"",length:0,toArray:function(){return N.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:N.call(this)},pushStack:function(a){a=d.merge(this.constructor(),a);a.prevObject=this;a.context=this.context;return a},each:function(a,
...
a[0]}function v(a,b,c,d,e){for(var f,g=[],h=0,k=a.length,l=null!=b;h<k;h++)if(f=a[h])if(!c||c(f,d,e))g.push(f),l&&b.push(h);return g}function t(a,c,f,g,h,k){g&&!g[z]&&(g=t(g));h&&!h[z]&&(h=t(h,k));return d(function(d,e,k,l){var m,p,q=[],r=[],pb=e.length,s;if(!(s=d)){s=c||"*";for(var n=k.nodeType?[k]:k,u=[],t=0,ha=n.length;t<ha;t++)b(s,n[t],u);s=u}s=!a||!d&&c?s:v(s,q,a,k,l);n=f?h||(d?a:pb||g)?[]:e:s;f&&f(s,n,k,l);if(g)for(m=v(n,r),g(m,[],k,l),k=m.length;k--;)if(p=m[k])n[r[k]]=!(s[r[k]]=p);if(d){if(h||
a){if(h){m=[];for(k=n.length;k--;)(p=n[k])&&m.push(s[k]=p);h(null,n=[],m,l)}for(k=n.length;k--;)(p=n[k])&&-1<(m=h?ga(d,p):q[k])&&(d[m]=!(e[m]=p))}}else n=v(n===e?n.splice(pb,n.length):n),h?h(null,e,n,l):aa.apply(e,n)})}function x(a){var b,c,d,e=a.length,f=r.relative[a[0].type];c=f||r.relative[" "];for(var g=f?1:0,h=u(function(a){return a===b},c,!0),k=u(function(a){return-1<ga(b,a)},c,!0),l=[function(a,c,d){a=!f&&(d||c!==I)||((b=c).nodeType?h(a,c,d):k(a,c,d));b=null;return a}];g<e;g++)if(c=r.relative[a[g].type])l=
[u(n(l),c)];else{c=r.filter[a[g].type].apply(null,a[g].matches);if(c[z]){for(d=++g;d<e&&!r.relative[a[d].type];d++);return t(1<g&&n(l),1<g&&s(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(Q,"$1"),c,g<d&&x(a.slice(g,d)),d<e&&x(a=a.slice(d)),d<e&&s(a))}l.push(c)}return n(l)}function y(a,c){var f=0<c.length,g=0<a.length,h=function(d,e,h,k,l){var m,p,q,s=0,n="0",ya=d&&[],u=[],t=I,ha=d||g&&r.find.TAG("*",l),z=H+=null==t?1:Math.random()||0.1,x=ha.length;for(l&&(I=e!==D&&e);n!==x&&null!=
(m=ha[n]);n++){if(g&&m){for(p=0;q=a[p++];)if(q(m,e,h)){k.push(m);break}l&&(H=z)}f&&((m=!q&&m)&&s--,d&&ya.push(m))}s+=n;if(f&&n!==s){for(p=0;q=c[p++];)q(ya,u,e,h);if(d){if(0<s)for(;n--;)ya[n]||u[n]||(u[n]=$.call(k));u=v(u)}aa.apply(k,u);l&&!d&&0<u.length&&1<s+c.length&&b.uniqueSort(k)}l&&(H=z,I=t);return ya};return f?d(h):h}var J,w,r,A,ha,va,Ma,B,I,ba,sa,fa,D,F,P,C,G,za,ua,z="sizzle"+1*new Date,E=a.document,H=0,K=0,L=c(),N=c(),O=c(),M=function(a,b){a===b&&(sa=!0);return 0},R=-2147483648,Z={}.hasOwnProperty,
ia=[],$=ia.pop,ca=ia.push,aa=ia.push,W=ia.slice,ga=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1},X="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Y="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+X+"))|)[\\x20\\t\\r\\n\\f]*\\]",T=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+
Y+")*)|.*)\\)|)",ea=RegExp("[\\x20\\t\\r\\n\\f]+","g"),Q=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),ka=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,la=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,ma=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),na=RegExp(T),oa=RegExp("^"+X+"$"),S={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w*")+")"),
ATTR:RegExp("^"+Y),PSEUDO:RegExp("^"+T),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)","i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)",
"i")},pa=/^(?:input|select|textarea|button)$/i,qa=/^h\d$/i,wa=/^[^{]+\{\s*\[native \w/,ra=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,da=/[+~]/,ta=/'|\\/g,U=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),V=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},ja=function(){fa()};try{aa.apply(ia=W.call(E.childNodes),E.childNodes),ia[E.childNodes.length].nodeType}catch(xa){aa={apply:ia.length?function(a,
b){ca.apply(a,W.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}w=b.support={};ha=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};fa=b.setDocument=function(a){var b=a?a.ownerDocument||a:E;if(b===D||9!==b.nodeType||!b.documentElement)return D;D=b;F=b.documentElement;(a=b.defaultView)&&a!==a.top&&(a.addEventListener?a.addEventListener("unload",ja,!1):a.attachEvent&&a.attachEvent("onunload",ja));P=!ha(b);w.attributes=f(function(a){a.className=
"i";return!a.getAttribute("className")});w.getElementsByTagName=f(function(a){a.appendChild(b.createComment(""));return!a.getElementsByTagName("*").length});w.getElementsByClassName=wa.test(b.getElementsByClassName);w.getById=f(function(a){F.appendChild(a).id=z;return!b.getElementsByName||!b.getElementsByName(z).length});w.getById?(r.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&P){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},r.filter.ID=function(a){var b=a.replace(U,
...
return d}return f};r.find.CLASS=w.getElementsByClassName&&function(a,b){if(P)return b.getElementsByClassName(a)};G=[];C=[];if(w.qsa=wa.test(b.querySelectorAll))f(function(a){F.appendChild(a).innerHTML="<a id='"+z+"'></a><select id='"+z+"-\f]' msallowcapture=''><option selected=''></option></select>";a.querySelectorAll("[msallowcapture^='']").length&&C.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||C.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
a.querySelectorAll("[id~="+z+"-]").length||C.push("~=");a.querySelectorAll(":checked").length||C.push(":checked");a.querySelectorAll("a#"+z+"+*").length||C.push(".#.+[+~]")}),f(function(a){var c=b.createElement("input");c.setAttribute("type","hidden");a.appendChild(c).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&C.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");a.querySelectorAll(":enabled").length||C.push(":enabled",":disabled");a.querySelectorAll("*,:x");C.push(",.*:")});(w.matchesSelector=
wa.test(za=F.matches||F.webkitMatchesSelector||F.mozMatchesSelector||F.oMatchesSelector||F.msMatchesSelector))&&f(function(a){w.disconnectedMatch=za.call(a,"div");za.call(a,"[s!='']:x");G.push("!=",T)});C=C.length&&RegExp(C.join("|"));G=G.length&&RegExp(G.join("|"));ua=(a=wa.test(F.compareDocumentPosition))||wa.test(F.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!!(d&&1===d.nodeType&&(c.contains?c.contains(d):a.compareDocumentPosition&&a.compareDocumentPosition(d)&
16))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1};M=a?function(a,c){if(a===c)return sa=!0,0;var d=!a.compareDocumentPosition-!c.compareDocumentPosition;if(d)return d;d=(a.ownerDocument||a)===(c.ownerDocument||c)?a.compareDocumentPosition(c):1;return d&1||!w.sortDetached&&c.compareDocumentPosition(a)===d?a===b||a.ownerDocument===E&&ua(E,a)?-1:c===b||c.ownerDocument===E&&ua(E,c)?1:ba?ga(ba,a)-ga(ba,c):0:d&4?-1:1}:function(a,c){if(a===c)return sa=!0,0;var d,e=0;d=a.parentNode;
var f=c.parentNode,g=[a],k=[c];if(!d||!f)return a===b?-1:c===b?1:d?-1:f?1:ba?ga(ba,a)-ga(ba,c):0;if(d===f)return h(a,c);for(d=a;d=d.parentNode;)g.unshift(d);for(d=c;d=d.parentNode;)k.unshift(d);for(;g[e]===k[e];)e++;return e?h(g[e],k[e]):g[e]===E?-1:k[e]===E?1:0};return b};b.matches=function(a,c){return b(a,null,null,c)};b.matchesSelector=function(a,c){(a.ownerDocument||a)!==D&&fa(a);c=c.replace(ma,"='$1']");if(w.matchesSelector&&P&&!(G&&G.test(c)||C&&C.test(c)))try{var d=za.call(a,c);if(d||w.disconnectedMatch||
...
c=!a[6]&&a[2];if(S.CHILD.test(a[0]))return null;a[3]?a[2]=a[4]||a[5]||"":c&&na.test(c)&&(b=va(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b));return a.slice(0,3)}},filter:{TAG:function(a){var b=a.replace(U,V).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=L[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&L(a,function(a){return b.test("string"===
...
h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,k){var l,m,p,q,s;c=f!==g?"nextSibling":"previousSibling";var n=b.parentNode,ob=h&&b.nodeName.toLowerCase();k=!k&&!h;if(n){if(f){for(;c;){for(m=b;m=m[c];)if(h?m.nodeName.toLowerCase()===ob:1===m.nodeType)return!1;s=c="only"===a&&!s&&"nextSibling"}return!0}s=[g?n.firstChild:n.lastChild];if(g&&k)for(k=n[z]||(n[z]={}),l=k[a]||[],q=l[0]===H&&l[1],p=l[0]===H&&l[2],m=q&&n.childNodes[q];m=++q&&m&&m[c]||(p=q=0)||s.pop();){if(1===
m.nodeType&&++p&&m===b){k[a]=[H,q,p];break}}else if(k&&(l=(b[z]||(b[z]={}))[a])&&l[0]===H)p=l[1];else for(;(m=++q&&m&&m[c]||(p=q=0)||s.pop())&&((h?m.nodeName.toLowerCase()!==ob:1!==m.nodeType)||!++p||(k&&((m[z]||(m[z]={}))[a]=[H,p]),m!==b)););p-=e;return p===d||0===p%d&&0<=p/d}}},PSEUDO:function(a,c){var f,g=r.pseudos[a]||r.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return g[z]?g(c):1<g.length?(f=[a,a,"",c],r.setFilters.hasOwnProperty(a.toLowerCase())?d(function(a,b){for(var d,
e=g(a,c),f=e.length;f--;)d=ga(a,e[f]),a[d]=!(b[d]=e[f])}):function(a){return g(a,0,f)}):g}},pseudos:{not:d(function(a){var b=[],c=[],f=Ma(a.replace(Q,"$1"));return f[z]?d(function(a,b,c,d){d=f(a,null,d,[]);for(var e=a.length;e--;)if(c=d[e])a[e]=!(b[e]=c)}):function(a,d,e){b[0]=a;f(b,null,e,c);b[0]=null;return!c.pop()}}),has:d(function(a){return function(c){return 0<b(a,c).length}}),contains:d(function(a){a=a.replace(U,V);return function(b){return-1<(b.textContent||b.innerText||A(b)).indexOf(a)}}),
lang:d(function(a){oa.test(a||"")||b.error("unsupported lang: "+a);a=a.replace(U,V).toLowerCase();return function(b){var c;do if(c=P?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===F},focus:function(a){return a===D.activeElement&&(!D.hasFocus||D.hasFocus())&&!!(a.type||a.href||
~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){a.parentNode&&a.parentNode.selectedIndex;return!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!r.pseudos.empty(a)},header:function(a){return qa.test(a.nodeName)},input:function(a){return pa.test(a.nodeName)},
...
0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:p(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};r.pseudos.nth=r.pseudos.eq;for(J in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})r.pseudos[J]=k(J);for(J in{submit:!0,reset:!0})r.pseudos[J]=l(J);m.prototype=r.filters=r.pseudos;r.setFilters=new m;va=b.tokenize=function(a,c){var d,e,f,g,h,k,l;if(h=N[a+" "])return c?0:h.slice(0);h=a;k=[];for(l=r.preFilter;h;){if(!d||(e=ka.exec(h)))e&&(h=h.slice(e[0].length)||h),k.push(f=[]);d=!1;if(e=la.exec(h))d=
e.shift(),f.push({value:d,type:e[0].replace(Q," ")}),h=h.slice(d.length);for(g in r.filter)!(e=S[g].exec(h))||l[g]&&!(e=l[g](e))||(d=e.shift(),f.push({value:d,type:g,matches:e}),h=h.slice(d.length));if(!d)break}return c?h.length:h?b.error(a):N(a,k).slice(0)};Ma=b.compile=function(a,b){var c,d=[],e=[],f=O[a+" "];if(!f){b||(b=va(a));for(c=b.length;c--;)f=x(b[c]),f[z]?d.push(f):e.push(f);f=O(a,y(e,d));f.selector=a}return f};B=b.select=function(a,b,c,d){var e,f,g,h,k="function"===typeof a&&a,l=!d&&va(a=
k.selector||a);c=c||[];if(1===l.length){f=l[0]=l[0].slice(0);if(2<f.length&&"ID"===(g=f[0]).type&&w.getById&&9===b.nodeType&&P&&r.relative[f[1].type]){b=(r.find.ID(g.matches[0].replace(U,V),b)||[])[0];if(!b)return c;k&&(b=b.parentNode);a=a.slice(f.shift().value.length)}for(e=S.needsContext.test(a)?0:f.length;e--;){g=f[e];if(r.relative[h=g.type])break;if(h=r.find[h])if(d=h(g.matches[0].replace(U,V),da.test(f[0].type)&&q(b.parentNode)||b)){f.splice(e,1);a=d.length&&s(f);if(!a)return aa.apply(c,d),c;
break}}}(k||Ma(a,l))(d,b,!P,c,da.test(a)&&q(b.parentNode)||b);return c};w.sortStable=z.split("").sort(M).join("")===z;w.detectDuplicates=!!sa;fa();w.sortDetached=f(function(a){return a.compareDocumentPosition(D.createElement("div"))&1});f(function(a){a.innerHTML="<a href='#'></a>";return"#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,b,c){if(!c)return a.getAttribute(b,"type"===b.toLowerCase()?1:2)});w.attributes&&f(function(a){a.innerHTML="<input/>";a.firstChild.setAttribute("value",
...
d.unique=ca.uniqueSort;d.text=ca.getText;d.isXMLDoc=ca.isXML;d.contains=ca.contains;var qb=d.expr.match.needsContext,rb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Jb=/^.[^:#\[\.,]*$/;d.filter=function(a,b,c){var e=b[0];c&&(a=":not("+a+")");return 1===b.length&&1===e.nodeType?d.find.matchesSelector(e,a)?[e]:[]:d.find.matches(a,d.grep(b,function(a){return 1===a.nodeType}))};d.fn.extend({find:function(a){var b,c=this.length,e=[],f=this;if("string"!==typeof a)return this.pushStack(d(a).filter(function(){for(b=0;b<
c;b++)if(d.contains(f[b],this))return!0}));for(b=0;b<c;b++)d.find(a,f[b],e);e=this.pushStack(1<c?d.unique(e):e);e.selector=this.selector?this.selector+" "+a:a;return e},filter:function(a){return this.pushStack(Ca(this,a||[],!1))},not:function(a){return this.pushStack(Ca(this,a||[],!0))},is:function(a){return!!Ca(this,"string"===typeof a&&qb.test(a)?d(a):a||[],!1).length}});var da,Yb=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(d.fn.init=function(a,b){var c;if(!a)return this;if("string"===typeof a){c="<"===
a[0]&&">"===a[a.length-1]&&3<=a.length?[null,a,null]:Yb.exec(a);if(!c||!c[1]&&b)return!b||b.jquery?(b||da).find(a):this.constructor(b).find(a);if(c[1]){if(b=b instanceof d?b[0]:b,d.merge(this,d.parseHTML(c[1],b&&b.nodeType?b.ownerDocument||b:t,!0)),rb.test(c[1])&&d.isPlainObject(b))for(c in b)if(d.isFunction(this[c]))this[c](b[c]);else this.attr(c,b[c])}else(c=t.getElementById(c[2]))&&c.parentNode&&(this.length=1,this[0]=c),this.context=t,this.selector=a;return this}if(a.nodeType)return this.context=
this[0]=a,this.length=1,this;if(d.isFunction(a))return"undefined"!==typeof da.ready?da.ready(a):a(d);void 0!==a.selector&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)}).prototype=d.fn;da=d(t);var Zb=/^(?:parents|prev(?:Until|All))/,$b={children:!0,contents:!0,next:!0,prev:!0};d.extend({dir:function(a,b,c){for(var e=[],f=void 0!==c;(a=a[b])&&9!==a.nodeType;)if(1===a.nodeType){if(f&&d(a).is(c))break;e.push(a)}return e},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===
...
a?d.extend(a,e):e}},f={};e.pipe=e.then;d.each(b,function(a,d){var k=d[2],l=d[3];e[d[1]]=k.add;l&&k.add(function(){c=l},b[a^1][2].disable,b[2][2].lock);f[d[0]]=function(){f[d[0]+"With"](this===f?e:this,arguments);return this};f[d[0]+"With"]=k.fireWith});e.promise(f);a&&a.call(f,f);return f},when:function(a){var b=0,c=N.call(arguments),e=c.length,f=1!==e||a&&d.isFunction(a.promise)?e:0,g=1===f?a:d.Deferred(),h=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?N.call(arguments):d;
c===k?g.notifyWith(b,c):--f||g.resolveWith(b,c)}},k,l,p;if(1<e)for(k=Array(e),l=Array(e),p=Array(e);b<e;b++)c[b]&&d.isFunction(c[b].promise)?c[b].promise().done(h(b,p,c)).fail(g.reject).progress(h(b,l,k)):--f;f||g.resolveWith(p,c);return g.promise()}});var ta;d.fn.ready=function(a){d.ready.promise().done(a);return this};d.extend({isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){(!0===a?--d.readyWait:d.isReady)||(d.isReady=!0,!0!==a&&0<--d.readyWait||(ta.resolveWith(t,
[d]),d.fn.triggerHandler&&(d(t).triggerHandler("ready"),d(t).off("ready"))))}});d.ready.promise=function(a){ta||(ta=d.Deferred(),"complete"===t.readyState?setTimeout(d.ready):(t.addEventListener("DOMContentLoaded",ma,!1),v.addEventListener("load",ma,!1)));return ta.promise(a)};d.ready.promise();var O=d.access=function(a,b,c,e,f,g,h){var k=0,l=a.length,p=null==c;if("object"===d.type(c))for(k in f=!0,c)d.access(a,b,k,c[k],!0,g,h);else if(void 0!==e&&(f=!0,d.isFunction(e)||(h=!0),p&&(h?(b.call(a,e),
...
b)this.cache[c]={};else for(d.isArray(b)?e=b.concat(b.map(d.camelCase)):(c=d.camelCase(b),b in f?e=[b,c]:(e=c,e=e in f?[e]:e.match(K)||[])),c=e.length;c--;)delete f[e[c]]},hasData:function(a){return!d.isEmptyObject(this.cache[a[this.expando]]||{})},discard:function(a){a[this.expando]&&delete this.cache[a[this.expando]]}};var n=new L,y=new L,Mb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Lb=/([A-Z])/g;d.extend({hasData:function(a){return y.hasData(a)||n.hasData(a)},data:function(a,b,c){return y.access(a,b,c)},
removeData:function(a,b){y.remove(a,b)},_data:function(a,b,c){return n.access(a,b,c)},_removeData:function(a,b){n.remove(a,b)}});d.fn.extend({data:function(a,b){var c,e,f,g=this[0],h=g&&g.attributes;if(void 0===a){if(this.length&&(f=y.get(g),1===g.nodeType&&!n.get(g,"hasDataAttrs"))){for(c=h.length;c--;)h[c]&&(e=h[c].name,0===e.indexOf("data-")&&(e=d.camelCase(e.slice(5)),Ua(g,e,f[e])));n.set(g,"hasDataAttrs",!0)}return f}return"object"===typeof a?this.each(function(){y.set(this,a)}):O(this,function(b){var c,
e=d.camelCase(a);if(g&&void 0===b){c=y.get(g,a);if(void 0!==c)return c;c=y.get(g,e);if(void 0!==c)return c;c=Ua(g,e,void 0);if(void 0!==c)return c}else this.each(function(){var c=y.get(this,e);y.set(this,e,b);-1!==a.indexOf("-")&&void 0!==c&&y.set(this,a,b)})},null,b,1<arguments.length,null,!0)},removeData:function(a){return this.each(function(){y.remove(this,a)})}});d.extend({queue:function(a,b,c){var e;if(a)return b=(b||"fx")+"queue",e=n.get(a,b),c&&(!e||d.isArray(c)?e=n.access(a,b,d.makeArray(c)):
...
c.empty&&(e++,c.empty.add(k));k();return f.promise(b)}});var ja=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,M=["Top","Right","Bottom","Left"],T=function(a,b){a=b||a;return"none"===d.css(a,"display")||!d.contains(a.ownerDocument,a)},sb=/^(?:checkbox|radio)$/i;(function(){var a=t.createDocumentFragment().appendChild(t.createElement("div")),b=t.createElement("input");b.setAttribute("type","radio");b.setAttribute("checked","checked");b.setAttribute("name","t");a.appendChild(b);x.checkClone=a.cloneNode(!0).cloneNode(!0).lastChild.checked;
a.innerHTML="<textarea>x</textarea>";x.noCloneChecked=!!a.cloneNode(!0).lastChild.defaultValue})();x.focusinBubbles="onfocusin"in v;var ac=/^key/,bc=/^(?:mouse|pointer|contextmenu)|click/,tb=/^(?:focusinfocus|focusoutblur)$/,ub=/^([^.]*)(?:\.(.+)|)$/;d.event={global:{},add:function(a,b,c,e,f){var g,h,k,l,p,q,m,s,u;if(p=n.get(a))for(c.handler&&(g=c,c=g.handler,f=g.selector),c.guid||(c.guid=d.guid++),(l=p.events)||(l=p.events={}),(h=p.handle)||(h=p.handle=function(b){return"undefined"!==typeof d&&d.event.triggered!==
b.type?d.event.dispatch.apply(a,arguments):void 0}),b=(b||"").match(K)||[""],p=b.length;p--;)k=ub.exec(b[p])||[],s=q=k[1],u=(k[2]||"").split(".").sort(),s&&(k=d.event.special[s]||{},s=(f?k.delegateType:k.bindType)||s,k=d.event.special[s]||{},q=d.extend({type:s,origType:q,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:u.join(".")},g),(m=l[s])||(m=l[s]=[],m.delegateCount=0,k.setup&&!1!==k.setup.call(a,e,u,h)||a.addEventListener&&a.addEventListener(s,
h,!1)),k.add&&(k.add.call(a,q),q.handler.guid||(q.handler.guid=c.guid)),f?m.splice(m.delegateCount++,0,q):m.push(q),d.event.global[s]=!0)},remove:function(a,b,c,e,f){var g,h,k,l,p,q,m,s,u,t,v,x=n.hasData(a)&&n.get(a);if(x&&(l=x.events)){b=(b||"").match(K)||[""];for(p=b.length;p--;)if(k=ub.exec(b[p])||[],u=v=k[1],t=(k[2]||"").split(".").sort(),u){m=d.event.special[u]||{};u=(e?m.delegateType:m.bindType)||u;s=l[u]||[];k=k[2]&&RegExp("(^|\\.)"+t.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=s.length;g--;)q=
s[g],!f&&v!==q.origType||c&&c.guid!==q.guid||k&&!k.test(q.namespace)||e&&!(e===q.selector||"**"===e&&q.selector)||(s.splice(g,1),q.selector&&s.delegateCount--,m.remove&&m.remove.call(a,q));h&&!s.length&&(m.teardown&&!1!==m.teardown.call(a,t,x.handle)||d.removeEvent(a,u,x.handle),delete l[u])}else for(u in l)d.event.remove(a,u+b[p],c,e,!0);d.isEmptyObject(l)&&(delete x.handle,n.remove(a,"events"))}},trigger:function(a,b,c,e){var f,g,h,k,l,p,q=[c||t],m=Ka.call(a,"type")?a.type:a;p=Ka.call(a,"namespace")?
...
d.now();this[d.expando]=!0};d.Event.prototype={isDefaultPrevented:R,isPropagationStopped:R,isImmediatePropagationStopped:R,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=na;a&&a.preventDefault&&a.preventDefault()},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=na;a&&a.stopPropagation&&a.stopPropagation()},stopImmediatePropagation:function(){var a=this.originalEvent;this.isImmediatePropagationStopped=na;a&&a.stopImmediatePropagation&&a.stopImmediatePropagation();
this.stopPropagation()}};d.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(a,b){d.event.special[a]={delegateType:b,bindType:b,handle:function(a){var e,f=a.relatedTarget,g=a.handleObj;if(!f||f!==this&&!d.contains(this,f))a.type=g.origType,e=g.handler.apply(this,arguments),a.type=b;return e}}});x.focusinBubbles||d.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){d.event.simulate(b,a.target,d.event.fix(a),!0)};d.event.special[b]=
...
f)if("object"===d.type(f))d.merge(l,f.nodeType?[f]:f);else if(cc.test(f)){g=g||k.appendChild(b.createElement("div"));h=(wb.exec(f)||["",""])[1].toLowerCase();h=I[h]||I._default;g.innerHTML=h[1]+f.replace(vb,"<$1></$2>")+h[2];for(h=h[0];h--;)g=g.lastChild;d.merge(l,g.childNodes);g=k.firstChild;g.textContent=""}else l.push(b.createTextNode(f));k.textContent="";for(p=0;f=l[p++];)if(!e||-1===d.inArray(f,e))if(a=d.contains(f.ownerDocument,f),g=A(k.appendChild(f),"script"),a&&Da(g),c)for(h=0;f=g[h++];)xb.test(f.type||
"")&&c.push(f);return k},cleanData:function(a){for(var b,c,e,f,g=d.event.special,h=0;void 0!==(c=a[h]);h++){if(d.acceptData(c)&&(f=c[n.expando])&&(b=n.cache[f])){if(b.events)for(e in b.events)g[e]?d.event.remove(c,e):d.removeEvent(c,e,b.handle);n.cache[f]&&delete n.cache[f]}delete y.cache[c[y.expando]]}}});d.fn.extend({text:function(a){return O(this,function(a){return void 0===a?d.text(this):this.empty().each(function(){if(1===this.nodeType||11===this.nodeType||9===this.nodeType)this.textContent=
...
g={};for(f in b)g[f]=a.style[f],a.style[f]=b[f];c=c.apply(a,d||[]);for(f in b)a.style[f]=g[f];return c};var gc=/^(none|table(?!-c[ea]).+)/,Qb=RegExp("^("+ja+")(.*)$","i"),hc=RegExp("^([+-])=("+ja+")","i"),ic={position:"absolute",visibility:"hidden",display:"block"},yb={letterSpacing:"0",fontWeight:"400"},cb=["Webkit","O","Moz","ms"];d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Y(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,
...
(l[b]="inherit"),h&&"set"in h&&void 0===(c=h.set(a,c,e))||(l[b]=c));else return h&&"get"in h&&void 0!==(f=h.get(a,!1,e))?f:l[b]}},css:function(a,b,c,e){var f,g;g=d.camelCase(b);b=d.cssProps[g]||(d.cssProps[g]=bb(a.style,g));(g=d.cssHooks[b]||d.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,c));void 0===f&&(f=Y(a,b,e));"normal"===f&&b in yb&&(f=yb[b]);return""===c||c?(a=parseFloat(f),!0===c||d.isNumeric(a)?a||0:f):f}});d.each(["height","width"],function(a,b){d.cssHooks[b]={get:function(a,e,f){if(e)return gc.test(d.css(a,
"display"))&&0===a.offsetWidth?d.swap(a,ic,function(){return fb(a,b,f)}):fb(a,b,f)},set:function(a,e,f){var g=f&&S(a);return db(a,e,f?eb(a,b,f,"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.cssHooks.marginRight=ab(x.reliableMarginRight,function(a,b){if(b)return d.swap(a,{display:"inline-block"},Y,[a,"marginRight"])});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,f={};for(c="string"===typeof c?c.split(" "):[c];4>d;d++)f[a+M[d]+b]=c[d]||
c[d-2]||c[0];return f}};$a.test(a)||(d.cssHooks[a+b].set=db)});d.fn.extend({css:function(a,b){return O(this,function(a,b,f){var g,h={},k=0;if(d.isArray(b)){f=S(a);for(g=b.length;k<g;k++)h[b[k]]=d.css(a,b[k],!1,f);return h}return void 0!==f?d.style(a,b,f):d.css(a,b)},a,b,1<arguments.length)},show:function(){return gb(this,!0)},hide:function(){return gb(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){T(this)?d(this).show():d(this).hide()})}});d.Tween=
...
a.now+a.unit):a.elem[a.prop]=a.now}}};B.propHooks.scrollTop=B.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};d.fx=B.prototype.init;d.fx.step={};var Z,xa,jc=/^(?:toggle|show|hide)$/,zb=RegExp("^(?:([+-])=|)("+ja+")([a-z%]*)$","i"),kc=/queueHooks$/,qa=[function(a,b,c){var e,f,g,h,k,l,p=this,q={},m=a.style,s=a.nodeType&&T(a),u=n.get(a,"fxshow");c.queue||(h=d._queueHooks(a,
...
for(b in q)d.style(a,b,q[b])}),q)b=ib(s?u[e]:0,e,p),e in u||(u[e]=b.start,s&&(b.end=b.start,b.start="width"===e||"height"===e?1:0))}],ea={"*":[function(a,b){var c=this.createTween(a,b),e=c.cur(),f=zb.exec(b),g=f&&f[3]||(d.cssNumber[a]?"":"px"),h=(d.cssNumber[a]||"px"!==g&&+e)&&zb.exec(d.css(c.elem,a)),k=1,l=20;if(h&&h[3]!==g){g=g||h[3];f=f||[];h=+e||1;do k=k||".5",h/=k,d.style(c.elem,a,h+g);while(k!==(k=c.cur()/e)&&1!==k&&--l)}f&&(h=c.start=+h||+e||0,c.unit=g,c.end=f[1]?h+(f[1]+1)*f[2]:+f[2]);return c}]};
d.Animation=d.extend(jb,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,e=0,f=a.length;e<f;e++)c=a[e],ea[c]=ea[c]||[],ea[c].unshift(b)},prefilter:function(a,b){b?qa.unshift(a):qa.push(a)}});d.speed=function(a,b,c){var e=a&&"object"===typeof a?d.extend({},a):{complete:c||!c&&b||d.isFunction(a)&&a,duration:a,easing:c&&b||b&&!d.isFunction(b)&&b};e.duration=d.fx.off?0:"number"===typeof e.duration?e.duration:e.duration in d.fx.speeds?d.fx.speeds[e.duration]:d.fx.speeds._default;
