    ...
    initialize: function(seri, options) {
        ...
        var frm = this.frm = new Element('iframe', {
            ...
            var documentTemplate = ['<html>',
                ...
                '<link rel="stylesheet" type="text/css" href="' + DESKTOPRESURL + '/stylesheets/wysiwyg_editor.css"/>',
                '</head>',
...
var mceHandler = new Class({
    ...
    dialog: function(action, options) {
        ...
        var url = ('image' == action) ? '?app=desktop&act=alertpages&goto=' + encodeURIComponent("?app=image&ctl=admin_manage&act=image_broswer&type=big") : '?ctl=editor&act=' + action;
