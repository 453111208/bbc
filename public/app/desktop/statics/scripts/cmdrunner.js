(function(){
    ...
    var cmdrunner = this.cmdrunner = new Class({
        ...
        createTpl:function(){
            ...
            var csol='<div class="console"><p class="csolinfo">loading...</p><span class="lnk csol" onClick="_open(\'?app=desktop&ctl=appmgr&act=app_console\')">'+LANG_Cmdrunner['console']+'</span></div>';
        ...
        progress:function(task){
            ...
            switch(task.type){
                case 'command':
                url='?app=desktop&ctl=appmgr&act=command&command_id='+task.command_id +'&data='+ encodeURIComponent(task.data);
                this.startTimer().parent(url);
                break;
                case 'dialog':
                url = '?app=desktop&ctl=appmgr&act='+task.action +'&data='+encodeURIComponent(task.data);
    ...
    var ApplicationManager = new Class({
        ...
        progress:function(actions){
            new Request.JSON({url: '?app=desktop&ctl=appmgr&act=prepare&action='+actions,
