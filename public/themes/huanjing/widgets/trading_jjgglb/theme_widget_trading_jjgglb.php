...
function theme_widget_trading_jjgglb(&$setting)
{
    	$sprodreleaseSql = "SELECT
				sbid.bidding_id, sbid.shop_id, sbid.shop_name, sbid.trading_title, ssp.shop_area, ssi.net_price,
			...
			GROUP BY 
			  sbid.bidding_id, sbid.shop_id, sbid.shop_name, sbid.trading_title, ssp.shop_area, ssi.net_price, tpt.mbid, tpt.cbid ORDER BY sbid.stop_time DESC LIMIT 5";
