...
class ectools_ctl_admin_payment extends desktop_controller{
    ...
    public function _views(){
        ...
        $sub_menu = array(
            0=>array('label'=>app::get('ectools')->_('失败'),'optional'=>false,'filter'=>array('status'=>array('failed'),'disabled'=>0)),
            1=>array('label'=>app::get('ectools')->_('已支付到担保方'),'optional'=>false,'filter'=>array('status'=>array('progress'),'disabled'=>0)),
            2=>array('label'=>app::get('ectools')->_('成功'),'optional'=>false,'filter'=>array('status'=>array('succ'),'disabled'=>0)),
            3=>array('label'=>app::get('ectools')->_('全部'),'optional'=>false,'filter'=>array('disabled'=>0)),
        );
        ...
        foreach($sub_menu as $k=>$v){
            if($v['optional']==false){
                ...
                $show_menu[$k]['href'] = '?app=ectools&ctl=admin_payment&act=index&view='.($k).(isset($_GET['optional_view'])?'&optional_view='.$_GET['optional_view'].'&view_from=dashboard':'');
