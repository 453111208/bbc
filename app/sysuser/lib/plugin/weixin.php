...
<?php
class sysuser_plugin_weixin implements sysuser_interface_trust
{
    public $name = '微信登陆';
    public $app_name = 'sysuser';
    public $ver = '2.0';
    public $view = 'sysuser/trust/weixin.html';
    ...
    {
        $this->my_url = url::action("topc_ctl_trustlogin@callBack",array('actionType'=>'sysuser_plugin_weixin'));
    ...
    {
       return app::get('sysuser')->setConf('sysuser_plugin_weixin', $data['data']);
    }
    ...
    public function get_logo()
    {
        ...
        $data['image'] = app::get('sysuser')->res_url.'/weixin.png';
