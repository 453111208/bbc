...
<?php
class sysuser_plugin_baidu implements sysuser_interface_trust
{
    public $name = '百度';
    public $app_name = 'sysuser';
    public $ver = '2.0';
    public $view = 'sysuser/trust/baidu.html';
    ...
    {
        $this->my_url = url::action("topc_ctl_trustlogin@callBack",array('actionType'=>'sysuser_plugin_baidu'));
    ...
    {
       return app::get('sysuser')->setConf('sysuser_plugin_baidu', $data['data']);
    }
    ...
    public function get_logo()
    {
        ...
        $data['url'] = $this->dialog_url.'?client_id='.$this->get_appkey()."&redirect_uri=" . urlencode($this->my_url) . "&state=". $_SESSION['baidust']."&response_type=code";
        return $data;
    }
