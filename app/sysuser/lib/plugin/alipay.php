...
<?php
class sysuser_plugin_alipay implements sysuser_interface_trust
{
    public $name = '支付宝';
    public $app_name = 'sysuser';
    public $ver = '2.0';
    public $view = 'sysuser/trust/alipay.html';
    ...
    {
       return app::get('sysuser')->setConf('sysuser_plugin_alipay', $data['data']);
    }
