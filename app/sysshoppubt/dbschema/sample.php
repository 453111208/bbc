...
return array (
    ...
    'name' =>
       ...
       'shop_id' => array(
            ...
            'required' => true,
            'comment' => app::get('sysshoppubt')->_('所属商家id'),
        ),
        ...
        'shop_name'=>array(
            ...
            'in_list'=>true,
            'width' => 110,
            'label' => app::get('sysshoppubt')->_('所属商家名称'),
            'comment' => app::get('sysshoppubt')->_('所属商家名称'),
        ),

        'user_id' => array(
            'type' => 'string',
            'length' => 50,
            'comment' => app::get('sysshoppubt')->_('参加商家的id'),
        ),
        ...
        'user_name' => array(
            ...
            'in_list'=>true,
            'width' => 110,
            'label' => app::get('sysshoppubt')->_('参加商家的名称'),
            'comment' => app::get('sysshoppubt')->_('参加商家的名称'),
        ),
