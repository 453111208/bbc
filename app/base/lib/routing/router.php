...
use base_http_response as Response;
use base_routing_route as Route;
...
class base_routing_router
{
  	...
  	public function __construct()
	{
        ...
        $this->routes = new base_routing_collection;
	...
	{
		return new base_routing_route($methods, $uri, $action);
	}
	 ...
	 */
	public function dispatch(base_http_request $request)
	{
