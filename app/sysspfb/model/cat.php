...
class sysspfb_mdl_cat extends dbeav_model {
    ...
    public function cat2json($return=false)
    {
        ...
        base_kvstore::instance('spfb')->store('goods_cat.data', $contents);
        if($return)
        {
            return $contents;
        }
    ...
    {
        if( base_kvstore::instance('spfb')->fetch('goods_cat.data', $contents) !== false )
        {
