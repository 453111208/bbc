...
return array (
    ...
    array (
        'article_id' =>array (
            'type' => 'number',
            'required' => true,
            'comment'=> app::get('sysinfo')->_('行情ID'),
            'autoincrement' => true,
            'width' => 50,
            'order'=>1,
        ),
        'title' =>array (
            ...
            'label' => app::get('sysinfo')->_('行情标题'),
            'order'=>2,
        ),
        'article_logo' => array(
            'type' => 'string',
            'label' => app::get('sysinfo')->_('行情logo'),
            'order'=>5,
            'comment' => app::get('sysinfo')->_('行情默认logo'),
        ),
        'platform' => array(
            'type' => array(
        ...
        'towhere' =>array(
            ...
            'in_list' => true,
            'default_in_list' => true,
            'comment' => app::get('sysinfo')->_('是否发布到行情中心'),
            'label' => app::get('sysinfo')->_('是否发布到行情中心'),
            'width' => 40,
            'order'=>11,
        ),
        'content' =>array (
            'type' => 'text',
            'comment'=> app::get('sysinfo')->_('行情内容'),
            'editable' => true,
        ),
        'user_id' =>array (
            'type' => 'number',
    ...
    'primary' => 'article_id',
    'comment' => app::get('sysinfo')->_('行情主表'),
);
