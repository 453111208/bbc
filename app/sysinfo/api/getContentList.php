<?php
class sysinfo_api_getContentList {

    /**
     * 接口作用说明
     */
    public $apiDescription = '获取资讯列表';
    ...
    {
        $sysinfoLibNode = kernel::single('sysinfo_article_article');
        return $sysinfoLibNode->getArticleList($params);
    }
}
