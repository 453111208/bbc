...
class site_theme_tmpl
{
    ...
    private function __get_tmpl_list($platform) {
        ...
        $ctl['pc'] = array(
            ...
            'articles'=>app::get('site')->_('咨询中心'),
            'articleslist'=>app::get('site')->_('咨询中心列表'),
            'articlesdtl'=>app::get('site')->_('咨询中心详情页'),
            'supplylist'=>app::get('site')->_('供求列表页'),
            'supplydtl'=>app::get('site')->_('供求详细页'),
            'markets'=>app::get('site')->_('行情中心'),
            'marketslist'=>app::get('site')->_('行情中心列表'),
            'marketsdtl'=>app::get('site')->_('行情中心详细页'),

            'marketstrad'=>app::get('site')->_('行情中心趋势图'),
          'biddingdtl'=>app::get('site')->_('竞价频道页'),
          'tenderdtl'=>app::get('site')->_('投标频道页'),
          'productdtl'=>app::get('site')->_('标准商品频道页'),
