...
class site_theme_tmpl
{
    ...
    private function __get_tmpl_list($platform) {
        ...
        $ctl['pc'] = array(
            ...
            'shopcenter'=>app::get('site')->_('企业首页'),
            ...
            'articles'=>app::get('site')->_('资讯中心'),
            'articleslist'=>app::get('site')->_('资讯中心列表'),
            'articlesdtl'=>app::get('site')->_('资讯中心详情页'),
            'hjgallery'=>app::get('site')->_('幻境列表页'),
            'hjproduct'=>app::get('site')->_('幻境商品详情'),
            'trading'=>app::get('site')->_('交易中心'),
            'market'=>app::get('site')->_('行情中心'),
            'marketDetails'=>app::get('site')->_('行情中心-详情'),
            'marketTrend'=>app::get('site')->_('行情走向'),
            'marketList'=>app::get('site')->_('行情列表'),
            'bidding'=>app::get('site')->_('竞价'),
            'tender'=>app::get('site')->_('招标'),
            'standard'=>app::get('site')->_('标准交易'),
            'expert' =>app::get('site')->_('名人专家'),
            'enterprise'=>app::get('site')->_('企业库'),
            'tenderrule'=>app::get('site')->_('招标规则'),
            'list'=>app::get('site')->_('搜索'),
            'third'=>app::get('site')->_('第三方服务'),
            'supply'=>app::get('site')->_('供求'),
