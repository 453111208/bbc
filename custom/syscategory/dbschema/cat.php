...
return array(
    'columns' => array(
        ...
        'belong' => array(
            ...
            'type' => 'string',
            'length' => 50,
            'comment' => app::get('syscategory')->_('归属'),
        ),
        'is_bz' => array(
            //'type' => 'varchar(50)',
             'type' => array(
                '1' => app::get('syscategory')->_('标准分类'),
                '2' => app::get('syscategory')->_('非标准分类'),
            ),
            'default' => '1',
            'length' => 50,
            'comment' => app::get('syscategory')->_('是否为标准商品分类'),
            'label' => app::get('syscategory')->_('是否为标准商品分类'),
             'in_list' => true,
            'default_in_list' => true,
        ),
    ),
