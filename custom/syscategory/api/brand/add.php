<?php
class syscategory_api_brand_add {

    /**
     * 接口作用说明
     */
    public $apiDescription = '添加商品品牌';
    ...
    public function getParams()
    {
        //接口传入的参数
        $return['params'] = array(
            'brand_id' => ['type'=>'int','valid'=>'', 'description'=>'品牌id','default'=>'','example'=>''],
    ...
    public function addBrand($apiData)
    {
        return kernel::single('syscategory_data_brand')->add($apiData);
    }
}
