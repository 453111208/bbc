...
class sysspfb_mdl_tariff extends dbeav_model{
    ...
    {
        //获取类目信息
        $catModel = app::get('sysspfb')->model('cat');
        $filter['level'] = 1;
        ...
        $schema = array(
            'columns'=>array(
                'cat_level_1'=>array(
                    ...
                    'type' => 'string',
                    'length' => 100,
                    'label' => app::get('sysspfb')->_( '一级类目'),
                ),
                'cat_level_2'=>array(
                    //'type'=>'varchar(100)',
                    'type' => 'string',
                    'length' => 100,
                    'label' => app::get('sysspfb')->_( '二级类目'),
                ),
                'cat_level_3'=>array(
                    //'type'=>'varchar(100)',
                    'type' => 'string',
                    'length' => 100,
                    'label' => app::get('sysspfb')->_( '三级类目'),
                ),
                'cat_service_rates'=>array(
                    //'type'=>'varchar(100)',
                    'type' => 'string',
                    'length' => 100,
                    'label' => app::get('sysspfb')->_( '类目费率 '),
                ),
                'platform_fee'=>array(
                    'type'=>'money',
                    'label' => app::get('sysspfb')->_( '平台使用费:单位-元/年'),
                ),
                'guarantee_money'=>array(
                    //'type'=>'varchar(100)',
                    'type' => 'string',
                    'length' => 100,
                    'label' => app::get('sysspfb')->_( '保证金:单位-元'),
                ),
            ),
        );
        return $schema;
