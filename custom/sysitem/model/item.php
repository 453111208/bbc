	...
	*/
    ...
    public function searchOptions(){
        ...
        $columns = array_merge(array(
            'shop_name'=>app::get('sysitem')->_('所属企业'),
    ...
    public function doDelete($params)
    {
        ...
        $standitem= app::get('sysshoppubt')->model("standard_item")->getList("*",array("item_id"=>$params['item_id']));
            if($standitem){
                    $msg = app::get('sysitem')->_('该商品正在交易中，无法删除！');
