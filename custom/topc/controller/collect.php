...
class topc_ctl_collect extends topc_controller{
    ...
    * @brief 添加企业收藏
    ...
    function ajaxFavshop() {
        ...
        {
            return $this->splash('error',null, app::get('topc')->_('企业已经收藏！'));
        }
        else
        {
           return  $this->splash('success',null,app::get('topc')->_('企业收藏添加成功'));
        }
    }
    ...
    * @brief 删除企业收藏
    ...
    function ajaxFavshopDel()
    {
        ...
        if(!$params['shop_id'])
        {
            return $this->splash('error',null, app::get('topc')->_('企业id不能为空！'));
        }
        if (!app::get('topc')->rpcCall('user.shopcollect.del', $params))
        {

            return $this->splash('error',null, app::get('topc')->_('企业收藏删除失败！'));
        }
        else
        {
           return  $this->splash('success',null,app::get('topc')->_('企业收藏删除成功'));
        }
    }
}
