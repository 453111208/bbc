...
class topshop_ctl_passport extends topshop_controller {
    ...
    public function login()
    {
        try
        {
            ...
            //jnpadd登录c端
            userAuth::attempt(input::get('login_account'), input::get('login_password'));
        }
        catch(Exception $e)
        {
            $msg = $e->getMessage();
    ...
    public function create()
    {
        ...
        try
        {
            ...
            userAuth::signUp(input::get('login_account'), input::get('login_password'), input::get('psw_confirm'));
        }
        catch(Exception $e)
        {
            $msg = $e->getMessage();
