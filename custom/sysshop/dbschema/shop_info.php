...
return  array(
    'columns'=>array(
        ...
        'shop_id'=>array(
            ...
            'in_list'=>true,
            'default_in_list'=>true,
            'label' => app::get('sysshop')->_('企业企业id'),
            'comment' => app::get('sysshop')->_('企业企业id'),
            'order' => 6,
        ),
        'company_name'=>array(
            //'type'=>'varchar(50)',
        ...
        'shop_hangye'=>array(
            ...
            'type' => 'string',
            'length' => 50,
            'label' => app::get('sysshop')->_('企业所属行业'),
            'comment' => app::get('sysshop')->_('企业所属行业'),
        ),
        'shop_xingzhi'=>array(
            //'type'=>'varchar(50)',
            'type' => 'string',
            'length' => 50,
            'label' => app::get('sysshop')->_('企业性质'),
            'comment' => app::get('sysshop')->_('企业性质'),
        ),
         'shop_guimo'=>array(
            //'type'=>'varchar(50)',
            'type' => 'string',
            'label' => app::get('sysshop')->_('企业规模'),
            'comment' => app::get('sysshop')->_('企业规模'),
        ),
         'shop_ziben'=>array(
            //'type'=>'varchar(50)',
            'type' => 'string',
            'label' => app::get('sysshop')->_('企业资本'),
            'comment' => app::get('sysshop')->_('企业资本'),
        ),
