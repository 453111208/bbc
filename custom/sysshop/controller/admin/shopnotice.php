...
class sysshop_ctl_admin_shopnotice extends desktop_controller{
    ...
    public function index()
    {
        return $this->finder('sysshop_mdl_shop_notice',array(
                'title'=>app::get('sysshop')->_('企业通知列表'),
                ...
                'actions'=>array(
                    ...
                    array(
                        ...
                        'target'=>'dialog::{ title:\''.app::get('sysshop')->_('企业通知类型').'\', width:400, height:200}',
    ...
    public function saveNoticeType()
    {
        ...
        if($result)
        {
            $msg = app::get('sysshop')->_('企业通知类型添加成功!');
            return $this->splash('success',null,$msg);
        }
        else
        {
            $msg = app::get('sysshop')->_('企业通知类型添加失败!');
            return $this->splash('error',null,$msg);
        }
    }
