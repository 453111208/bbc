...
class sysshop_api_shop_getNoticeList{
    ...
    public $apiDescription = "获取企业通知";
    public function getParams()
    {
        $return['params'] = array(
            'shop_id' => ['type'=>'int','valid'=>'required','description'=>'企业id','default'=>'','example'=>''],
            'notice_type' => ['type'=>'string','valid'=>'','description'=>'企业id','default'=>'','example'=>''],
